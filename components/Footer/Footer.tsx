  ...
  return (
    <>
      <div className={styles.footerContainer}>
        <div className={`app-max-width app-x-padding gap-20 ${styles.footerContents}`}>
          <div className="flex items-center flex-col text-center">
            <svg aria-hidden="true" focusable="false" fill="none" stroke-width="1.5" width="24" className="hidden sm:block icon icon-picto-delivery-truck" viewBox="0 0 24 24">
          ...
          <div className="flex items-center flex-col text-center">
            <svg aria-hidden="true" focusable="false" fill="none" stroke-width="1.5" width="24" className="hidden sm:block icon icon-picto-award-gift" viewBox="0 0 24 24">
          ...
          <div className="flex items-center flex-col text-center">
          <svg aria-hidden="true" focusable="false" fill="none" stroke-width="1.5" width="24" className="hidden sm:block icon icon-picto-plane" viewBox="0 0 24 24">
      <path clip-rule="evenodd" d="m20.055 20.198.654-.654c.36-.36.502-.885.373-1.378l-2.326-8.837 3.075-3.075a2.972 2.972 0 0 0 .422-3.794 2.867 2.867 0 0 0-4.369-.37l-3.183 3.185L5.867 2.95a1.434 1.434 0 0 0-1.38.373l-.653.654A1.434 1.434 0 0 0 4.11 6.22l6.03 3.618-4.589 5.2-1.434.02a1.434 1.434 0 0 0-1.225.37L1.46 16.74a.716.716 0 0 0 .225 1.165l2.767 1.56 1.816 2.864a.718.718 0 0 0 1.166.224l1.251-1.193c.354-.333.515-.822.428-1.3l.023-1.438 5.058-4.73 3.618 6.03a1.434 1.434 0 0 0 2.243.276Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></path>
          ...
          <div className="flex items-center flex-col text-center">
          <svg aria-hidden="true" focusable="false" fill="none" stroke-width="1.5" width="24" viewBox="0 0 24 24">
      ...
      <div className={styles.bottomFooter}>
        <div className="app-max-width app-x-padding w-full flex justify-between">
          <span className="">@2023 Dharmik Wear - all rights reserved</span>
